public class GuessGame {
    ...
    public void startGame() {
        ...
        while(true) {
            System.out.println("Number to get is " + targetNumber);
            ...
            // check each player's guess to see if it matches the target number. If
            // a player is right, then set that player's variable to be true
            ...
            // if player one OR player two OR palyer three is right...
            ...
            // otherwise, stay in the loop and ask the players for another guess.
                ...
                // we must keep going because nobdy got it right!
